...
import com.lzp.classroomassistant.message.adapter.AgreeHolder;
import com.lzp.classroomassistant.message.adapter.OnRecyclerViewListener;
import com.lzp.classroomassistant.message.adapter.ReceiveImageHolder;
import com.lzp.classroomassistant.message.adapter.ReceiveLocationHolder;
import com.lzp.classroomassistant.message.adapter.ReceiveTextHolder;
import com.lzp.classroomassistant.message.adapter.ReceiveVideoHolder;
import com.lzp.classroomassistant.message.adapter.ReceiveVoiceHolder;
import com.lzp.classroomassistant.message.adapter.SendImageHolder;
import com.lzp.classroomassistant.message.adapter.SendLocationHolder;
import com.lzp.classroomassistant.message.adapter.SendTextHolder;
import com.lzp.classroomassistant.message.adapter.SendVideoHolder;
import com.lzp.classroomassistant.message.adapter.SendVoiceHolder;
