...
import com.lzp.classroomassistant.message.ChatActivity;
...
public class PrivateConversation extends Conversation{
    ...
    private static final String TAG = "PrivateConversation";
    ...
    public void onClick(Context context) {
        ...
        Log.d(TAG, " draft == " + conversation.getDraft());
        if (bundle != null) {
...
//        BmobIM.getInstance().deleteConversation(conversation.getConversationId());
    ...
    private void getName(User munber){
