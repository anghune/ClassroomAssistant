...
import com.lzp.classroomassistant.model.UserModel;
...
public class DemoMessageHandler extends BmobIMMessageHandler {
    ...
    private final static String TAG = "DemoMessageHandler";
    ...
    public void onMessageReceive(final MessageEvent event) {
        ...
        Log.i("",event.getConversation().getConversationTitle() + "," + event.getMessage().getMsgType() + "," + event.getMessage().getContent());
        excuteMessage(event);
    }
...
//                                info.getName(),msg.getContent(),"您有一条新消息",pendingIntent);
    ...
    private void processCustomMessage(BmobIMMessage msg, BmobIMUserInfo info){
        //自行处理自定义消息类型
        Log.i(TAG,msg.getMsgType() + "," + msg.getContent() + "," + msg.getExtra());
